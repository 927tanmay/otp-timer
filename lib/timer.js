...
var Otp = /*#__PURE__*/function (_Component) {
  ...
  function Otp(props) {
    ...
    _this.state = {
      showfield: false,
      minutes: _this.props.options.min,
      seconds: _this.props.options.sec
    };
    return _this;
  }
  ...
  _createClass(Otp, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        style: buttonStyling
      }, "Resend") : /*#__PURE__*/_react.default.createElement("span", null, "Time left:", " ", this.state.minutes < 10 ? "0".concat(this.state.minutes) : this.state.minutes, ":", this.state.seconds < 10 ? "0".concat(this.state.seconds) : this.state.seconds));
    }
  }]);
